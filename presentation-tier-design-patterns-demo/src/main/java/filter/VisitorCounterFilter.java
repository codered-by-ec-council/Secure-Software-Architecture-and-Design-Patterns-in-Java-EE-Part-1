...
public class VisitorCounterFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        HttpSession session = ((HttpServletRequest) httpServletRequest).getSession(false);
        //if (session != null && session.getAttribute("username") != null) {
            users.add(session.getAttribute("username").toString());
...
//        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("VisitorCounterFilter:Initializing filter");
            }
        }
    }
